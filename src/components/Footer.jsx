              ...
              <div className="ftco-footer-widget mb-4">
                ...
                <div className="d-flex">
                  <ul className="list-unstyled mr-l-5 pr-l-3 mr-4">
                    <li>
                      <a href="#" className="py-2 d-block">Shipping Information</a>
                    </li>
                    <li>
                      <a href="#" className="py-2 d-block">Returns &amp; Exchange</a>
                    </li>
                    <li>
                      <a href="#" className="py-2 d-block">Terms &amp; Conditions</a>
                    </li>
            ...
            <div className="col-md">
              <div className="ftco-footer-widget mb-4">
                ...
                <div className="block-23 mb-3">
                  <ul>
                    <li>
                      <span className="icon icon-map-marker" /><span className="text">Berlin</span>
                    </li>
                    <li>
                      <a href="#"><span className="icon icon-phone" /><span className="text">+375(29)3389065</span></a>
                    </li>
                    <li>
                      <a href="#"><span className="icon icon-envelope" /><span className="text">yukhnelmaria@gmail.com</span></a>
                    </li>
                  </ul>
                </div>
              </div>
